...
namespace FirebaseEssentials.iOS
{
	public class FirebasePushNotificationManager : NSObject, IFirebasePushNotification, IUNUserNotificationCenterDelegate, IMessagingDelegate
	{
		...
		public void RegisterForPushNotifications()
		{
			...
			if (UIDevice.CurrentDevice.CheckSystemVersion(10, 0)) {
				...
				UNUserNotificationCenter.Current.RequestAuthorization(authOptions, (granted, error) => {
					if (error != null) {
						_onNotificationError?.Invoke(CrossFirebaseEssentials.Notifications, new FirebasePushNotificationErrorEventArgs(FirebasePushNotificationErrorType.PermissionDenied, error.Description));
					} else if (!granted) {
						_onNotificationError?.Invoke(CrossFirebaseEssentials.Notifications, new FirebasePushNotificationErrorEventArgs(FirebasePushNotificationErrorType.PermissionDenied, "Push notification permission not granted"));
					} else {
		...
		{
			_onNotificationError?.Invoke(CrossFirebaseEssentials.Notifications, new FirebasePushNotificationErrorEventArgs(FirebasePushNotificationErrorType.RegistrationFailed, error.Description));
		}

		public void ApplicationReceivedRemoteMessage(RemoteMessage remoteMessage)
		{
			Console.WriteLine(remoteMessage.AppData);
			Debug.WriteLine("ApplicationReceivedRemoteMessage");
		...
		public void DidReceiveRegistrationToken(Messaging messaging, string fcmToken)
		{
			...
			if (!string.IsNullOrEmpty(refreshedToken)) {
				_onTokenRefresh?.Invoke(CrossFirebaseEssentials.Notifications, new FirebasePushNotificationTokenEventArgs(refreshedToken));
				hasToken = true;
